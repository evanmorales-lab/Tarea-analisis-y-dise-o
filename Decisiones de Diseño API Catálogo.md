...
Decisión 2: El contenido no tiene un estado "restringido": El campo Status de contenido editorial tiene 3 valores: borrador, publicado y despublicado, las restricciones no agregan un cuarto valor porque un contenido puede estar publicado para la mayoría del mundo y restringido para un grupo especifico.
